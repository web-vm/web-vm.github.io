      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <Link 
            ...
            className={cn(
              "nav-link", 
              location.pathname === "/" && "text-softepy-gold"
            )}
          >
            Home
          </Link>
          <Link 
            ...
            className={cn(
              "nav-link", 
              location.pathname === "/about" && "text-softepy-gold"
            )}
          >
            About
          </Link>
          <Link 
            ...
            className={cn(
              "nav-link", 
              location.pathname === "/product" && "text-softepy-gold"
            )}
          >
            Product
          </Link>
          <Link 
            ...
            className={cn(
              "nav-link", 
              location.pathname === "/franchise" && "text-softepy-gold"
            )}
          >
            Franchise
          </Link>
          <Link 
            ...
            className={cn(
              "nav-link", 
              location.pathname === "/contact" && "text-softepy-gold"
            )}
          >
            Contact
          </Link>
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-softepy-dark focus:outline-none"
