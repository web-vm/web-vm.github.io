...
const Footer = () => {
  ...
  return (
    <footer className="bg-softepy-dark text-white pt-16 pb-8">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="bg-gray-800 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-softepy-gold"
              />
              <button 
                type="submit"
                className="bg-softepy-gold text-softepy-dark px-4 py-2 rounded-md font-medium hover:bg-opacity-90 transition-colors"
              >
                Subscribe
              </button>
            </form>
