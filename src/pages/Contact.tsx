...
Message: ${formData.message}
      ...
      if (response.ok) {
        ...
        throw new Error('Failed to send message. Please call us directly at +91 81222 40900.');
      }
    } catch (error) {
      console.error('Error sending message:', error);
      toast({
        title: "Error sending message",
        description: "Please try again later or contact us directly at +91 81222 40900.",
        variant: "destructive"
      });
    } finally {
                ...
                <div className="space-y-8 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      <strong>Phone:</strong> +91 81247 69245
                    </p>
                    <p className="text-gray-600 mb-2">
                      <strong>Email:</strong> contact@thepy.in
                    </p>
                    {/* <p className="text-gray-600">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <InViewAnimation animation="fade-in-up">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="tel:+918124769245" className="btn-primary inline-flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                  </svg>
                  Call Franchise Team
                </a>
                <a href="mailto:contact@thepy.in" className="btn-secondary inline-flex items-center bg-white text-softepy-dark">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
